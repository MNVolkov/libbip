...
import 0x08046C8E get_system_ms  					alias_get_system_ms								@	@	get_system_ms
...
import 0x080438F0 _write_flash                    	alias__write_flash	@ функция не вызывается напрямую из приложений по соображениям целостности данных
