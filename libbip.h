...
extern	void* 	pvPortMalloc (int size);                                                  //	выделение памяти 
...
extern 	int 	read_res_by_id(int res_id, int offset, void* buffer, int len);            //	чтение определенного ресурса по его номеру и оффсету от начала ресурса
